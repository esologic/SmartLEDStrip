...
(function(window, document, undefined) {
    ...
    function ColorPicker(slideElement, pickerElement, callback) {
        ...
        if (slideElement.attachEvent) {
            ...
            slideElement.addEventListener('mousedown', startDragging, false);
            pickerElement.addEventListener('mousedown', startDragging, false);
            ...
            pickerElement.addEventListener('click', function( e ) {
              q.dragging = true;
              pickerFunc(e);
              q.dragging = false;
            }, false);
